...
public class DemoExtentReport implements IReporter {

	private ExtentReports extent;
	DemoScreenshot testUtil;

	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		extent = new ExtentReports(outputDirectory + File.separator + "DemoExtentReport.html", true);
